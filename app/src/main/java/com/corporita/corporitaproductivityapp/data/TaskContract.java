package com.corporita.corporitaproductivityapp.data;
...
public class TaskContract {
    ...
    public static final String AUTHORITY = "com.corporita.todolist";
    ...
    public static final class TaskEntry implements BaseColumns {
        ...
        public static final String COLUMN_PRIORITY2 = "priority2";

        public static final String COLUMN_DESCRIPTION3 = "description3";
        public static final String COLUMN_PRIORITY3 = "priority3";

        public static final String COLUMN_DESCRIPTION4 = "description4";
        public static final String COLUMN_PRIORITY4 = "priority4";
