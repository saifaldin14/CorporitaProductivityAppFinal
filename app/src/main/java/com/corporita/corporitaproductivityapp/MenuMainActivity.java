    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                getSupportLoaderManager().restartLoader(TASK_LOADER_ID, null, MenuMainActivity.this);
        ...
        fabButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addTaskIntent = new Intent(MenuMainActivity.this, AddTaskActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.homeButt:
                ...
                return true;
            case R.id.goalsButt:
                Intent y = new Intent(this, GoalsPage.class);
                startActivity(y);
                overridePendingTransition(R.anim.left_to_mid,R.anim.mid_to_right);
                return true;
            case R.id.taskButt:
